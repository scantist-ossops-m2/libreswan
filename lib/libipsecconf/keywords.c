...
const struct keyword_def ipsec_conf_keywords[] = {
  ...
  { "iptfs",  kv_conn,  kt_enum,  KNCF_IPTFS, yn_option_names, NULL, },
  { "iptfs-dont-frag",  kv_conn,  kt_enum,  KNCF_IPTFS_DONT_FRAG, yn_option_names, NULL, },
  ...
  { "iptfs-init-delay",  kv_conn,  kt_binary,  KNCF_IPTFS_IN_DELAY, NULL, NULL, },
